...
router.get('/profile',passport.checkAuthentication, userControl.profile); //this become localhost:3000/users/profile
...
router.get('/signout',userControl.destroySession);
